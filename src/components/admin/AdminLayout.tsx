...
import { Settings, Building2, ExternalLink, KeyRound, Brain, ScrollText, BookOpen, Users, Activity, LogOut, MessageSquare, BarChart3, Plug } from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { to: '/admin/integracoes', label: 'Integrações', icon: Plug, roles: ['admin'] },
